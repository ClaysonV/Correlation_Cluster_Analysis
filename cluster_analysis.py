...
assets = {
    ...
    "Precious Metals": ["GLD", "SLV", "GDX"], # GDX is Gold Miners
...
# Dropping 'multi_level_index' to avoid the yfinance bug
data = yf.download(tickers, start="2022-01-01", end="2024-01-01", progress=False, multi_level_index=False)['Close']
